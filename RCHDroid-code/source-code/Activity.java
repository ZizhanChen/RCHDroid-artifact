...
//------------------------------------------zizhan--------------------------------------------//
     ...
     * {@hide}
     */
    private boolean mZizhanState = false; 
//------------------------------------------zizhan--------------------------------------------//
    ...
    protected void onResume() {
        ...
        Slog.e(TAG, "[zizhan] Activity onResume called at [" + now + "]");
...
//------------------------------------------zizhan--------------------------------------------//
     ...
     * @hide
     */                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
    public void setZizhanState(boolean zizhanStateOn){
        if (zizhanStateOn){
            mZizhanState = true; 
            if (mDecor != null) {
                mDecor.dispatchZizhanFlagChanged(View.ZIZHAN_STATE_ON); 
            }
            
        } else {
            mZizhanState = false; 
            if (mDecor != null){
                mDecor.dispatchZizhanFlagChanged(View.ZIZHAN_STATE_OFF);
            }
        }
    }
     ...
     * @hide
     */
    public HashMap<Integer, View> getAllViewsZizhan() {
        return getAllChildViewsZizhan(mDecor);
    }
 
    /**
     * @hide
     */
    private HashMap<Integer, View> getAllChildViewsZizhan(View view) {
        HashMap<Integer, View> tmpViewMap = new HashMap<Integer, View>();
        if (view instanceof ViewGroup) {
            ViewGroup vp = (ViewGroup) view;
            for (int i = 0; i < vp.getChildCount(); i++) {
                View viewChild = vp.getChildAt(i);
                if (viewChild.getId() != View.NO_ID) {
                    //Log.e(TAG, "[zizhan], view added to hash map [" + viewChild.getId() + ", " + viewChild.getClass().getName() + "]");
                    tmpViewMap.put(viewChild.getId(),viewChild);
                } else {
                    //Log.e(TAG, "[zizhan], view not added because of no id [" + viewChild.getId() + ", " + viewChild.getClass().getName() + "]");
                }
                tmpViewMap.putAll(getAllChildViewsZizhan(viewChild));
            }
        }
        return tmpViewMap;
    }
     ...
     * @hide
     */
    public void setNewViewsZizhan(HashMap<Integer, View> newViews) {
        setNewChildViewsZizhan(mDecor, newViews);
    }

    /**
     * @hide
     */
    private void setNewChildViewsZizhan(View view, HashMap<Integer, View> newViews) {
        if (view instanceof ViewGroup) {
            ViewGroup vp = (ViewGroup) view;
            for (int i = 0; i < vp.getChildCount(); i++) {
                View viewChild = vp.getChildAt(i);
                if (viewChild.getId() != View.NO_ID) {
                    View tmpNewView = newViews.get(viewChild.getId());
                    if (tmpNewView != null) {
                        //Log.e(TAG, "[zizhan], view found in hash map [" + viewChild.getId() + ", " + viewChild.getClass().getName() + "]");
                        viewChild.setNewViewZizhan(tmpNewView);
                    } else {
                        //Log.e(TAG, "[zizhan], view not found, [" + viewChild.getId() + ", " + viewChild.getClass().getName() + "]");
                    }
                }
                setNewChildViewsZizhan(viewChild, newViews);
            }
        }
    }
//------------------------------------------zizhan--------------------------------------------//
