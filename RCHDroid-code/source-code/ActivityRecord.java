...
//------------------------------------------zizhan--------------------------------------------//
    private boolean mZizhanState = false; // is this activity is in shadow state?
//------------------------------------------zizhan--------------------------------------------//
    ...
    boolean moveFocusableActivityToTop(String reason) {
        ...
        if (currentFocusedApp != null && currentFocusedApp.task == task
            ...
            if (task == topFocusableTask) {
                if (currentFocusedApp == this) {
                    ...
                    //Slog.d(TAG, "[zizhan] moveFocusableActivityToTop: already on top "
                    //        + "and focused, activity=" + this);
                } else {
                    //Slog.d(TAG, "[zizhan] moveFocusableActivityToTop: set focused, "
                    //        + "activity=" + this);
                ...
                //Slog.d(TAG, "[zizhan] moveFocusableActivityToTop: the return value is "
                //            + !isState(RESUMED));
        ...
        //Slog.d(TAG, "[zizhan] moveFocusableActivityToTop: activity="+ this);
...
//------------------------------------------zizhan--------------------------------------------//
    public boolean getZizhanState() {
        return mZizhanState;
    }

    public void setZizhanState(boolean state) {
        mZizhanState = state;
    }
//------------------------------------------zizhan--------------------------------------------//
...
//------------------------------------------zizhan--------------------------------------------//
        ...
        Slog.e(TAG_CONFIGURATION, "[zizhan] never relaunch activity");                
        final long now = SystemClock.uptimeMillis();
        Slog.e(TAG_CONFIGURATION, "[zizhan] configuration change happened at [" + now + "]");
        if (false) {
//------------------------------------------zizhan--------------------------------------------//
